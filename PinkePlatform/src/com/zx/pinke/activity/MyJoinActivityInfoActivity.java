...
public class MyJoinActivityInfoActivity extends BaseListActivity implements
		IXListViewListener {
	private static Log logger = LogFactory.getLog(MyJoinActivityInfoActivity.class);
	...
	private static final int REQUEST_CODE_MYJOIN = 5;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_activity_my_join);
	...
	protected void initHeader(View view) {
		...
		mSearchDeleteBtn = (Button) view.findViewById(R.id.delete);
			...
			public void onClick(View v) {
				...
				try {
					...
					mBackgroundQueryHandler
							.cancelOperation(TOKEN_QUERY_CONTENT);
					URI uri = new URI(AppConfig.NetWork.IV.URL_PUBLIC_SERVICE);
					mTipTv.setText(R.string.loading_and_waiting);
					mQueryCondition.resetCondition("active_title", null);
					mBackgroundQueryHandler.startPost(TOKEN_QUERY_CONTENT,
							true, uri, mQueryCondition.getQueryParams());
				} catch (Exception e) {
					xListView.stopRefresh();
				}
			}
		});
		mSearchBtn = (Button) view.findViewById(R.id.btn_right_header);
					...
					if (!TextUtils.isEmpty(content)) {
						try {
							...
							mBackgroundQueryHandler
									.cancelOperation(TOKEN_QUERY_CONTENT);
							URI uri = new URI(
									AppConfig.NetWork.IV.URL_PUBLIC_SERVICE);
							mTipTv.setText(R.string.loading_and_waiting);
							mQueryCondition.resetCondition("active_title",
									content);
							mBackgroundQueryHandler.startPost(
									TOKEN_QUERY_CONTENT, true, uri,
		...
		mBackBtn= (Button) view.findViewById(R.id.btn_left_header);
	...
	private void initViews() {
		...
		mAdapter = new PublicServicePaginationAdapter(MyJoinActivityInfoActivity.this,
				getServiceFromLocal());
		...
		xListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MyJoinActivityInfoActivity.this,MyJoinActivityInfoDetailActivity.class);
				intent.putExtra("ps",publicService);
				startActivityForResult(intent, REQUEST_CODE_MYJOIN);
			}
		...
		public View getView(final int position, View view, ViewGroup parent) {
			...
			imageView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					PublicService publicService = mItems.get(position);
					Intent intent = new Intent(MyJoinActivityInfoActivity.this,UserInfoActivity.class);
	...
	private static String[] PROJECTION = { PublicServiceColumn.ID,
			...
			PublicServiceColumn.LAUNCH ,PublicServiceColumn.NEED_NUM,
	...
	private static final int LAUNCH_COLUMN = 13;
	private static final int NEED_NUM_COLUMN = 14;
	...
	private List<PublicService> getServiceFromLocal() {
		...
		String orderBy = PublicServiceColumn.ID + " asc limit " + limit
				+ " offset " + 0;
		CursorLoader loader = new CursorLoader(this, uri, PROJECTION, IVDatas.PublicServiceColumn.LAUNCH+ "!=?", new String[]{AccountInfo.getAccountInfo().getAccount()}, orderBy);
	...
	class QueryCondition {
		...
		public Map<String, Object> getQueryParams() {
			//myactive 的值有"myjoin","mylaunch","","null"
			params.put("myActive", "myjoin");
			//activeweek的值有"1"，"2"，"3"，"null"，""
			params.put("active_week", "");
			...
			try {
				...
				if (CODE_SUCCESS == resultCode) {
					if (isRefresh) {// 更新操作
						...
						db.beginTransaction();
						try {
							db.delete(IVDatas.PUBLIC_SERVICE,IVDatas.PublicServiceColumn.LAUNCH+ "!=?", new String[]{AccountInfo.getAccountInfo().getAccount()});
						...
						if (jsonArray.length() == 0) {
							Toast.makeText(MyJoinActivityInfoActivity.this, "没有更多内容了！",
									Toast.LENGTH_SHORT);
						}
					}
				} else if (CODE_FAIL == resultCode) {
					Toast.makeText(MyJoinActivityInfoActivity.this, "数据加载失败！",
							Toast.LENGTH_SHORT).show();
				}
	...
	protected String getHeaderTitle() {
		// TODO Auto-generated method stub
		return getString(R.string.title_my_join);
	}
	
	@Override
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if(requestCode == REQUEST_CODE_MYJOIN){
